...
<<<<<<< HEAD
        <div class="bottom"><img src="../../src/assets/3.png" style="width:100%;vertical-align: bottom;"></div>
=======
        <div class="bottom"><img src="../assets/3.png" style="width:100%;vertical-align: bottom;"></div>
